  ...
  return (
    <View style={[styles.container, { backgroundColor: isDarkMode ? Colors.black : Colors.white }]}>
      ...
      <View style={styles.buttonsContainer}>
        <Tlacitka_u_radku title="1" onPress={() => console.log('Tlačítko 1 bylo stisknuto.')} />
        <Tlacitka_u_radku title="2" onPress={() => console.log('Tlačítko 2 bylo stisknuto.')} />
        <Tlacitka_u_radku title="3" onPress={() => console.log('Tlačítko 3 bylo stisknuto.')} />
      </View>
    </View>
  );
};
